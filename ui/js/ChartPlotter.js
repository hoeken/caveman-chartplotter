  ...
  loadInitialData() {
    ...
    this.loadConfig()
      .then(async () => {
        ...
        // bulk load. Seed the fleet cache from the snapshot we already hold,
        // then open the websocket — the first connect subscribes vessels.*
        // immediately against this seed (see setupWebsockets).
        this.buildMap();
