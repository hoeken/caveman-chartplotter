...
// each control asks what it needs (canWrite to store preferences, canAdmin for
...
// with (see src/http-routes.js): readonly reads, readwrite saves preferences,
// admin replaces the boat icon.
...
export class Identity {
  ...
  // Storing this identity's UI preferences — everything the plugin registers
  // as readwrite.
  canWrite() {
