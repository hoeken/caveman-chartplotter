...
- **[signalk-questdb](https://github.com/dirkwa/signalk-questdb)** (or any v2 History API provider): rebuilds your own track from the last 24 hours of recorded position history when the tracks plugin can't supply it.
- **[@signalk/tracks-plugin](https://github.com/SignalK/tracks)**: required for other vessels' historical tracks, and the preferred source for your own. I recommend a resolution of 1000ms and 86400 points, which gives you high-resolution data for the last 24 hours. If you've got the memory, you might as well use it.
