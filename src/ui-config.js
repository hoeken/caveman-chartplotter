...
//                                  from pre-1.5 installs survive as the
//                                  boat-wide baseline
...
export class UiConfigStore {
  ...
  // Errors propagate: a failed preference save should surface to the caller,
  // not vanish.
  ...
  // One-shot upgrade for pre-1.5 installs, where UI preferences lived in the
